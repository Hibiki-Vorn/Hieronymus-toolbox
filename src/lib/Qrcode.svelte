...
<div class="qrcode-container">
    ...
    <div>
        <ol>
            ...
            <li>
                ...
                <select
                    bind:value={conf.errorCorrectionLevel}
    ...
    <Modal
        title="OR generated successfully"
        show={img !== null}
        close={() => {
            img = null;
